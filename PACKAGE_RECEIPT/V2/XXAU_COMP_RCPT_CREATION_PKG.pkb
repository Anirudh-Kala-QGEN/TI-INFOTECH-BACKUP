...
IS
	...
	BEGIN
		...
		, PROCESS_MESSAGE = PROCESS_MESSAGE||'-'||P_PROCESS_MESSAGE
		WHERE 1=1
		AND (CONS_RCPT_NO = P_CONS_RCPT_NO OR P_CONS_RCPT_NO IS NULL)
		AND (COMPOSITE_RECEIPT_ID = P_COMPOSITE_RECEIPT_ID OR P_COMPOSITE_RECEIPT_ID IS NULL)
		;
		*/
			...
			THEN
				...
				AR_RECEIPT_API_PUB.CREATE_MISC
					...
					THEN
						...
						PRAGMA_COMMIT('E','Error while creating MISC Receipt'||' - Error while creating Composite Receipt.',I.CONS_RCPT_NO ,NULL );
						--COMMIT;
