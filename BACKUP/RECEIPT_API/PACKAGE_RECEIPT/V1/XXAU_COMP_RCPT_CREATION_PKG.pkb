...
IS
	...
	LC_COMMENTS_H:=NULL;
		...
		DBMS_OUTPUT.PUT_LINE('LC_COMMENTS_H : '||LC_COMMENTS_H||' FOR RECEIPT NUM :'||'C'||I.CONS_RCPT_NO);
		...
		THEN
			...
			DBMS_OUTPUT.PUT_LINE('LC_FLAG_H : '||LC_FLAG_H||' FOR RECEIPT NUM :'||'C'||I.CONS_RCPT_NO);
			IF LC_FLAG_H <> 'E'
			THEN
				FND_MSG_PUB.INITIALIZE;
				...
				AR_RECEIPT_API_PUB.CREATE_MISC
					...
					IF l_return_status <> FND_API.G_RET_STS_SUCCESS THEN
						...
						PRAGMA_COMMIT('E','Error while creating MISC Receipt'||' - Error while creating Composite Receipt.',I.CONS_RCPT_NO ,I.CONS_RCPT_NO );
						--COMMIT;
