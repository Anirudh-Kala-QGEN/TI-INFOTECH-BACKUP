                ...
                BEGIN
                    ...
                    THEN
                        ...
                        THEN
							...
							PRAGMA_COMMIT ('E',J.PROCESS_MESSAGE || LC_ERROR,I.CONS_RCPT_NO,J.COMPOSITE_RECEIPT_ID);
            ...
            THEN
                ...
                THEN
					...
					AR_RECEIPT_API_PUB.CREATE_MISC (
                        ...
                        x_msg_data             => l_msg_data,
                        p_currency_code        => 'INR',
                        p_amount               => LN_TOTAL_RCPT_AMT*-1, -- AMOUNT ?
                        ...
                        p_receipt_method_id    => LN_RECEIPT_METHOD_ID_REC, --I.RECEIPT_METHOD_ID, -- (SELECT RECEIPT_METHOD_ID FROM ADDB.ADDB_XXA_AR_TRANS_ERP_RCPT WHERE CONS_RCPT_NO = 12;)
                        p_activity             => NULL,
