CREATE OR REPLACE PACKAGE BODY XXAU_AP_INV_WITH_GST_TDS_PKG2
IS
    /*************************************************************************************************
...
---------------------------------------------------------------------------------------------------------------------------------
	...
	AS
		...
		AND ((SELECT COUNT(1) 
			...
			AND PARTY_NAME = B.PARTY_NAME
			AND OPERATING_UNIT = B.OPERATING_UNIT)=(SELECT COUNT(1) 
													FROM XXAU_AP_INV_WITH_GST_TDS_TBL 
													WHERE PROCESS_FLAG = 'V' 
													AND INVOICE_NUMBER = B.INVOICE_NUMBER
													AND PARTY_NAME = B.PARTY_NAME
