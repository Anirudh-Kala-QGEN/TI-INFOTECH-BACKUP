...
IS
     ...
     * ===============  =========   =============   ======================================================================================
     * AKALA            1.0         1-APR-2026      Initial Version - Create Procedure (MAIN, VALIDATE_REQUIRED AND CREATE_CUSTOMERS_SITES)
     * AKALA            1.1         2-APR-2026      Updated Version - Create Procedure (CREATE_CUSTOMER_AND_SITES
																						, CREATE_PARTY 
																						and CREATE_CUST_ACCOUNT)
     * AKALA            1.2         6-APR-2026      Updated Version - Create Procedure (CREATE_LOCATION
																						, CREATE_CUST_SITE_USES 
																						and CREATE_PARTY_SITE)
     * AKALA            1.3         7-APR-2026      Updated Version - Create Procedure (CREATE_CONTACT_POINT_SITE_LVL
																						, CREATE_SAFALTA_CUST_AND_SITES 
																						and CREATE_CUST_ACCT_SITE)
     * AKALA            1.4         8-APR-2026      Updated Version - Create Procedure (Update conditions in CREATE_CUSTOMER_AND_SITES 
																						and CREATE_SAFALTA_CUST_AND_SITES)
     * AKALA            1.5         9-APR-2026      Updated Version - Create Procedure (Updated CREATE_CONTACT_POINT_SITE_LVL - For Creating 
																						Phone and Email Contact Points)
	 ************************************************************************************************************************************/


	 /*************************************************************************************************
     * Program Name : CREATE_CONTACT_POINT
     * Language     : PL/SQL
     ...
     * ===============  =========   =============   ====================================================
     * AKALA            1.0         7-APR-2026     Initial Version
     * AKALA            1.0         8-APR-2026     Updated for Creation customer account according to the Name of Center
     ***************************************************************************************************/	
				...
				-- THEN
					...
					LOOP
								CREATE_CUST_ACCOUNT (P_ORGANIZATION_NAME 	=> I.AGENCY_NAME
													, P_ACCOUNT_NAME 		=> J.NAME_OF_CENTRE
					...
					-- Resetting the Variables for Updating and Correct values
						...
						BEGIN
							...
							THEN																	 
								...
								-- Creating Contact Point -- Added on 08-APR-2026
									...
									END IF;
								-- Added Email and phone contact points on 08-APR-2026
     ...
     * AKALA            1.2         08-APR-2026     Upgraded code for EMAIL and PHONE creation in ERP
     ***************************************************************************************************/		
     ...
     * AKALA            1.2         08-APR-2026     Added the code for creating Email and phone contact points
     ***************************************************************************************************/
					...
					BEGIN
						...
						IF LN_LOCATION_ID > 0
							THEN
								...
								IF LN_PARTY_SITE_ID > 0
								THEN 
								-- Creating Contact Point -- Added by AKALA on 08-APR-2026
									CREATE_CONTACT_POINT_SITE_LVL ( P_PARTY_SITE_ID => LN_PARTY_SITE_ID
																  , P_PHONE => J.MOBILE_NO 
																  , P_EMAIL => J.EMAIL
																  , P_TABLE => 'HZ_PARTY_SITES'
