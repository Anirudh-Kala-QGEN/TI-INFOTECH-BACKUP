CREATE OR REPLACE PACKAGE XXAU_CREATE_CUSTOMER_SITE_PKG
IS

    /***************************************************************************************************
     * Global Variables : Declaration and Initialization
     ***************************************************************************************************/
	 GN_USER_ID NUMBER := 1117; --FND_PROFILE.VALUE('USER_ID');
	 GN_ORG_ID NUMBER := 288; --FND_PROFILE.VALUE('ORG_ID');
	 GN_RESP_ID NUMBER := 50677; --FND_PROFILE.VALUE('RESP_ID');
	 GN_RESP_APPL_ID NUMBER := 222; --FND_PROFILE.VALUE('RESP_APPL_ID');
    /****************************************************************************************************/
